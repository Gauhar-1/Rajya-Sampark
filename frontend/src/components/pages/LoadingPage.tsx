...
export const LoadingPage = () => {
  return (
    <div className="min-h-screen bg-white rounded-lg dark:bg-gray-900 flex items-center  justify-center transition-colors duration-300">
      <style jsx global>{`
        /* Embedded CSS for Animations and Dark Mode SVG handling */
        :root {
            --hue: 223;
        ...
        .pl {
            ...
            /* Using standard CSS units since the SVG attributes are absolute */
            width: 8em; 
            height: 8em;
        }
        .pl__ring {
            stroke: hsla(var(--hue), 10%, 10%, 0.9);
        ...
        /* Dark theme override for SVG elements */
        .dark .pl__ring {
